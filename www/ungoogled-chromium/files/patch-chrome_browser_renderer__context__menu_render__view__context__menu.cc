--- chrome/browser/renderer_context_menu/render_view_context_menu.cc.orig	2026-04-02 08:54:25 UTC
...
+    BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(IS_BSD)
 #include "components/webapps/isolated_web_apps/scheme.h"
         ...
         // BUILDFLAG(IS_CHROMEOS)
@@ -5133,7 +5133,7 @@ void RenderViewContextMenu::OpenLinkInSplitView() {
