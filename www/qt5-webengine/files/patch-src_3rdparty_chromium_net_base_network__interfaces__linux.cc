--- src/3rdparty/chromium/net/base/network_interfaces_linux.cc.orig	2018-11-13 18:25:11 UTC
...
+#endif // !defined(OS_FREEBSD)
 ...
 #include <sys/ioctl.h>
 #include <sys/types.h>
@@ -49,6 +51,7 @@ bool TryConvertNativeToNetIPAttributes(int native_attr
...
@@ -66,6 +69,10 @@ bool TryConvertNativeToNetIPAttributes(int native_attr
   }
...
@@ -80,13 +87,15 @@ NetworkChangeNotifier::ConnectionType GetInterfaceConn
   if (!s.is_valid())
...
@@ -95,12 +104,13 @@ NetworkChangeNotifier::ConnectionType GetInterfaceConn
...
+#if !defined(OS_FREEBSD)
   ...
   if (!ioctl_socket.is_valid())
     return std::string();
@@ -112,9 +122,11 @@ std::string GetInterfaceSSID(const std::string& ifname
...
@@ -214,12 +227,16 @@ bool GetNetworkList(NetworkInterfaceList* networks, in
   if (networks == NULL)
     return false;
